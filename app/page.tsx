        ...
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="relative px-4 py-5 sm:px-6 -mt-16">
            ...
            <p className="mt-2 max-w-2xl text-center text-xl text-gray-500 dark:text-gray-400 mx-auto">
              Second Year at University of Vermont
            </p>
          </div>
          <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-5 sm:px-6">
            <h2 className="text-lg font-medium text-gray-900 dark:text-white">About Me</h2>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              I'm currently studying Computer Science at the University of Vermont. In my free time, I love to ski and play the drums. I am always looking for new projects and opportunities to learn and grow as a developer. 
            </p>
          </div>
          <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-5 sm:px-6">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-5 sm:px-6">
            ...
            <ul className="mt-2 divide-y divide-gray-200 dark:divide-gray-700">
              {[
                ...
                { name: 'Personal Portfolio', description: 'Built with Next.js and Tailwind CSS'},
              ].map((project, index) => (
